...
<head>
    ...
    <title>API Security Lab 2</title>
...
<body>
    ...
    <div class="container">
        <div class="main-container">
            ...
            <div id="profileSection" style="display: none;">
                ...
                <!-- Admin Panel - Sadece role=2 için görünür -->
                <div id="adminPanel" style="display: none;" class="mt-4">
                    <div class="card bg-dark text-white">
                        <div class="card-body">
                            ...
                            <p class="card-text">Təbriklər! Role manipulation açığını tapdınız.</p>
                            <div class="alert alert-warning">
                                <strong>İpucu:</strong> Register request'inde role parametrini yoxlayın.
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- API Security Hints -->
            <div class="hint">
                <p class="mt-2"><strong>Qeyd:</strong> Bu lab'da role manipulation açığını tapmalısınız.</p>
            </div>
            ...
            <div class="report-section mt-5">
                ...
                <form id="reportForm" action="get_reports.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="lab_type" value="API Lab 2">
                    <div class="mb-3">
    ...
    <div class="modal fade" id="registerModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Qeydiyyat</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form id="registerForm">
                        ...
                        <button type="submit" class="btn btn-success w-100">Qeydiyyat</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function checkSession() {
            const sessionCookie = document.cookie
                .split('; ')
                .find(row => row.startsWith('session2='));
        ...
        async function makeRequest(endpoint, method, data) {
            ...
            let url = `/api2/user/${endpoint}`;
            
            if (endpoint === 'update-password' && sessionCookie) {
                const userData = JSON.parse(atob(sessionCookie.split('=')[1]));
                url = `/api2/user/${userData.id}`;
                data = {
            ...
            try {
                ...
                if (endpoint === 'login' && result.token) {
                    const isAdmin = result.role === 2;
                    
                    document.cookie = `session2=${btoa(JSON.stringify({
                        id: result.id,
                ...
                alert('Bir səhv baş verdi: ' + error.message);
            }
        }
        ...
        function logout() {
            document.cookie = 'session2=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;';
            checkSession();
        }
