...
<body>
    ...
    <div class="container">
        <div class="main-container">
            <h2 class="text-center mb-4">XSS Lab 5</h2>
            
            <form method="GET" action="">
                <div class="input-group mb-3">
                    <input type="text" class="form-control search-input" name="username" 
                           placeholder="Adınızı daxil edin" 
                           value="<?php 
                               if(isset($_GET['username'])) {
                                   $username = preg_replace("/[^a-zA-Z0-9\s\'()\-]/", "", $_GET['username']);
                                   echo $username;
                               }
                           ?>">
                    <button class="btn search-btn" type="submit">Göndər</button>
                </div>
            </form>
            ...
            ?>
                <div class="results">
                    <div class="result-card card">
                        <div class="card-body">
                            <script>
                                var foo='<?php echo $username; ?>';
                                document.write("Salam, " + foo + "!");
                            </script>
                        </div>
                    </div>
                </div>
            ...
            <div class="report-section mt-5">
                ...
                <form id="reportForm" action="get_reports.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="lab_type" value="XSS Lab 5">
                    <div class="mb-3">
