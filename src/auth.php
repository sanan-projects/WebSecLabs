...
if (isset($_GET['logout'])) {
    // Əvvəlcə session məlumatlarını təmizləyək
    $_SESSION = array();
    
    // Session cookie-ni silek
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Təhlükəsiz olmayan sorğu - SQL injection lab üçün
            ...
            <?php if (isset($_SESSION['auth_user'])): ?>
                <div class="ms-auto user-profile">
                    <div class="user-avatar">
                        <?php echo strtoupper(substr($_SESSION['auth_user']['username'], 0, 1)); ?>
                    </div>
                    <div class="dropdown">
    ...
    <div class="container">
        <?php if (!isset($_SESSION['auth_user'])): ?>
            <div class="login-container">
                <h2 class="text-center mb-4">Broken Authentication Lab</h2>
                ...
                <div class="report-section mt-5">
                    ...
                    <form id="reportForm" action="get_reports.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="lab_type" value="Auth Lab">
                        <div class="mb-3">
        ...
        <?php else: ?>
            <div class="login-container text-center">
                ...
                <div class="alert alert-success">
                    <strong><?php echo htmlspecialchars($_SESSION['auth_user']['username']); ?></strong> olaraq giriş etdiniz.
                </div>
                <?php if (isset($_SESSION['auth_user']) && $_SESSION['auth_user']['role'] === 'admin'): ?>
                    <div class="mt-3">
                        <a href="admin_chat.php" class="btn btn-info w-100">
    ...
    <div id="chatbot-container">
        <div class="chat-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <button class="btn-close text-white" id="close-chat"></button>
            </div>
        </div>
        ...
        function sendMessage() {
            ...
            if (message) {
                ...
                .catch(error => {
                    ...
                    addMessage('bot', 'Bağışlayın, bir xəta baş verdi.');
                });
