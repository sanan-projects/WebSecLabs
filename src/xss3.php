...
if (!$is_valid) {
    ...
    session_start(); // Session'ı en başta başlatalım
    
if(isset($_GET['search'])) {
    $search = $_GET['search'];
    // < veya > karakteri kontrolü
    if(strpos($search, '<') !== false || strpos($search, '>') !== false) {
        // Aramayı session'a kaydet
        $_SESSION['invalid_search'] = $search;
        // 404 status kodu ile yönlendirme
...
<body>
    ...
    <div class="container">
        <div class="main-container">
            <h2 class="text-center mb-4">XSS Lab 3</h2>
            ...
            <div class="report-section mt-5">
                ...
                <form id="reportForm" action="get_reports.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="lab_type" value="XSS Lab 3">
                    <div class="mb-3">
